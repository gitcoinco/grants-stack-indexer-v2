...
import { ERFTimestampsUpdatedHandler } from "../../../../src/processors/strategy/easyRetroFunding/handlers/timestampsUpdated.handler.js";
import { createMockEvent } from "../../../mocks/index.js";

describe("ERFTimestampsUpdatedHandler", () => {
    let handler: ERFTimestampsUpdatedHandler;
    ...
    it("handle a valid timestamps update event", async () => {
        ...
        handler = new ERFTimestampsUpdatedHandler(mockEvent, chainId, {
