...
import { ERFRegisteredHandler } from "../../../../src/processors/strategy/easyRetroFunding/handlers/registered.handler.js";
import { createMockEvent } from "../../../mocks/index.js";

describe("ERFRegisteredHandler", () => {
    let handler: ERFRegisteredHandler;
    ...
    const defaultStrategyId = "0x060ffd6c79f918819a622248c6823443412aedea610cc19c89d28dadcdef7fba";
    ...
    it("handles a valid registration event", async () => {
        ...
        handler = new ERFRegisteredHandler(mockEvent, chainId, {
